    ...
    while( ros::ok()  )
    {
        ...
        while( params.run )
        {
            ...
            case 8:
                ...
                {
                    flg_result=flg_result= Campospotenciales(intensity,light_readings, lidar_readings, 
															params.laser_num_sensors,params.laser_value,
															q_light,q_inputs,&movements,&est_sig ,
															params.robot_max_advance ,params.robot_turn_angle);
		...
		if(action_data != 0){
		 ...
		 est_sig=0;
               ...
               flg_result= Campospotenciales(intensity,light_readings, lidar_readings, params.laser_num_sensors,params.laser_value,
